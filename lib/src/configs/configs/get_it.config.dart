...
import 'package:translatetribune/src/configs/modules/app_modules.dart' as _i10;
...
import 'package:translatetribune/src/data/services/language.dart' as _i7;
import 'package:translatetribune/src/data/services/notifications.dart' as _i6;
import 'package:translatetribune/src/data/services/saved_articles.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.LanguagesService>(() => _i7.LanguagesService());
    gh.lazySingleton<_i8.SavedArticlesDao>(
        () => _i8.SavedArticlesDao(gh<_i4.AppDatabase>()));
    gh.lazySingleton<_i9.SavedArticlesService>(
        () => _i9.SavedArticlesService(gh<_i8.SavedArticlesDao>()));
    return this;
  }
}

class _$AppModules extends _i10.AppModules {}
